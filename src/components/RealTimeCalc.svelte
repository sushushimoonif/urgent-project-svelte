<script lang="ts">
  ...
  function generateMockRealtimeData() {
    // 基础数据模板（使用您提供的数据结构）
    const baseData = [
      { name: "低压轴换算转速", baseValue: 100 },
      { name: "高压轴换算转速", baseValue: 100.21423 },
      { name: "发动机进口换算流量", baseValue: 130.01865 },
      { name: "发动机净推力", baseValue: 94.25875 },
      { name: "发动机总推力", baseValue: 94.25875 },
      { name: "发动机进口冲压阻力", baseValue: 0 },
      { name: "发动机总耗油量", baseValue: 5171.314 },
      { name: "主燃烧室耗油量", baseValue: 5171.314 },
      { name: "加力燃烧室耗油量", baseValue: 0 },
      { name: "喷管喉道面积", baseValue: 0.26 },
      { name: "喷管出口面积", baseValue: 0.34999996 },
      { name: "风扇出口温度", baseValue: 464.7087 },
      { name: "高压压气机出口温度", baseValue: 798.9966 },
      { name: "高压涡轮进口温度", baseValue: 1360.5674 },
      { name: "低压涡轮进口温度", baseValue: 1221.1287 },
      { name: "风扇出口总压", baseValue: 101324.984 },
      { name: "高压压气机出口总压", baseValue: 1834008.1 },
      { name: "高压涡轮出口总压", baseValue: 689877.3 },
      { name: "低压涡轮出口总压", baseValue: 689877.3 },
      { name: "低压涡轮出口总温", baseValue: 689877.3 },
      { name: "喷管喉道静压", baseValue: 178118.44 },
      { name: "喷管喉道总压", baseValue: 333455.8 },
      { name: "喷管喉道静温", baseValue: 741.8981 },
      { name: "喷管喉道总温", baseValue: 333455.8 },
      { name: "喷管喉道气流速度", baseValue: 717.0412 },
      { name: "喷管出口静压", baseValue: 635.4891 },
      { name: "喷管出口总压", baseValue: 333455.8 },
      { name: "喷管出口静温", baseValue: 635.4891 },
      { name: "喷管出口总温", baseValue: 881.21704 },
      { name: "喷管出口气流速度", baseValue: 717.0412 },
      { name: "喷管推力损失系数", baseValue: 0 },
      { name: "状态码", baseValue: 0 }
    ];

    // 生成带有随机变化的模拟数据
    const mockData = baseData.map(item => ({
      name: item.name,
      data: [item.baseValue + (Math.random() - 0.5) * item.baseValue * 0.1] // 添加±10%的随机变化
    }));
